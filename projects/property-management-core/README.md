...
이 문서는 `projects/property-management-core` 기준입니다.

- 건축물대장 API/n8n/Apps Script 자산은 `../building-ledger-automation`으로 분리되었습니다.
- 입주자모집공고 PDF 정규화 파이프라인은 `../apartment-notice-normalization`으로 분리되었습니다.
